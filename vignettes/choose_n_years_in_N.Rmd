...
# print(system.time({dt_score_quantile <- get_dt_score_quantile_fast(array_sample = array_sample_random[,1:1000], dt_series = dt_series, col_vec = c("value_1", "value_2"), upper_quantile_boundary = 0.99)}))
